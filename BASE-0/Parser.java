...
public class Parser implements ParserConstants {
  ...
  static final public ASTNode TopExp() throws ParseException {
        ASTNode t;
    t = AssignExp();
          {if (true) return t;}
    throw new Error("Missing return statement in function");
  ...
  static final public ASTNode AssignExp() throws ParseException {
  ASTNode t1,t2;
    t1 = BoolExp();
    label_1:
    while (true) {
  ...
  static final public ASTNode BoolExp() throws ParseException {
   ASTNode t1, t2;
    t1 = DisjExp();
    label_2:
    while (true) {
  ...
  static final public ASTNode DisjExp() throws ParseException {
   ASTNode t1, t2;
    t1 = EqExp();
    label_3:
    while (true) {
  ...
  static final public ASTNode EqExp() throws ParseException {
   ASTNode t1, t2;
    t1 = Exp();
    if (jj_2_4(2)) {
      jj_consume_token(EQ);
  ...
  ASTNode t2=null;
    if (jj_2_11(2)) {
      ...
      n = jj_consume_token(FALSE);
               t2 = new ASTBoolean(false); {if (true) return t2;}
    } else if (jj_2_19(2)) {
